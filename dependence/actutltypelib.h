/****************************************************************************
**
** Namespace ActUtlTypeLib generated by dumpcpp v5.14.2 using
...
{
public:
    explicit IActUtlType(IDispatch *subobject = nullptr, QAxObject *parent = nullptr);
    /*
...
{
public:
    explicit IActMLUtlType(IDispatch *subobject = nullptr, QAxObject *parent = nullptr);
    /*
    Property ActLogicalStationNumber
...
{
public:
    explicit ActUtlType(QWidget *parent = nullptr, Qt::WindowFlags f = {});
...
{
public:
    explicit ActMLUtlType(QWidget *parent = nullptr, Qt::WindowFlags f = {});
