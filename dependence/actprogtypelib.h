/****************************************************************************
**
** Namespace ActProgTypeLib generated by dumpcpp v5.14.2 using
...
{
public:
    explicit IActProgType(IDispatch *subobject = nullptr, QAxObject *parent = nullptr);
    /*
...
{
public:
    explicit IActMLProgType(IDispatch *subobject = nullptr, QAxObject *parent = nullptr);
    /*
    Property ActBaudRate
...
{
public:
    explicit ActProgType(QWidget *parent = nullptr, Qt::WindowFlags f = {});
...
{
public:
    explicit ActMLProgType(QWidget *parent = nullptr, Qt::WindowFlags f = {});
